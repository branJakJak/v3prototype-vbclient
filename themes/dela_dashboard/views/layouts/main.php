...
<html lang="en">
	<head>
		...
		<link rel="stylesheet/less" type="text/css" href="<?php echo $baseUrl ?>/less/bootstrap.less">
		<script src="<?php echo $baseUrl ?>/js/less/less.js" type="text/javascript"></script>
		<link rel="stylesheet" href="<?php echo $baseUrl ?>/style/fullcalendar.css" />	

		<link rel="stylesheet" href="<?php echo $baseUrl ?>/style/delta.main.css" />
		<link rel="stylesheet" href="<?php echo $baseUrl ?>/style/delta.grey.css"/>
	...
	<?php require_once 'sidebar_menu.php'; ?>
	  ...
	  <div id="mainBody">
		...
		<div class="container-fluid">
							...
							<ul class="recent-posts">
								<li>
									<div class="user-thumb">
										<img width="40" height="40" alt="User" src="<?php echo $baseUrl ?>/images/avatar2.png">
									</div>
								...
								<li>
									<div class="user-thumb">
										<img width="40" height="40" alt="User" src="<?php echo $baseUrl ?>/images/avatar3.png">
									</div>
									<div class="article-post">
								...
								<li>
									<div class="user-thumb">
										<img width="40" height="40" alt="User" src="<?php echo $baseUrl ?>/images/avatar1.png">
									</div>
									<div class="article-post">
            ...
            <script src="<?php echo $baseUrl ?>/js/excanvas.min.js"></script>
            ...
            <script src="<?php echo $baseUrl ?>/js/fullcalendar.min.js"></script>
            <script src="<?php echo $baseUrl ?>/js/delta.js"></script>
            <script src="<?php echo $baseUrl ?>/js/delta.dashboard.js"></script>
	</body>
</html>