        ...
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <div class="nav-collapse">
			<?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'encodeLabel'=>false,
                    'items'=>array(
                        array('label'=>'<a href="" class="logo"></a>', 'url'=>array('/site/page', 'view'=>'about')),
                        ...
                        array('label'=>'Login', 'url'=>array('/user/login'), 'visible'=>Yii::app()->user->isGuest,'linkOptions'=>array("data-description"=>"member area")),
                        array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/user/logout'), 'visible'=>!Yii::app()->user->isGuest,'linkOptions'=>array("data-description"=>"member area")),
                    ),
                )); ?>
    	</div>
    </div>
